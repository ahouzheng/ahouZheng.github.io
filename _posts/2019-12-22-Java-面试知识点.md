...
## 25.实现动态代理的几种方式? 区别?
**参考文章：[article](https://blog.csdn.net/weixin_36759405/article/details/82770422?depth_1.utm_source=distribute.pc_relevant.none-task&utm_source=distribute.pc_relevant.none-task)**  
静态代理是在编译期就确定的代理关系  
动态代理是在运行过程中实现的代理。
实现动态代理有两种方式：  
1. JDK原生动态代理
...
代理类需要与被代理类实现相同的接口，Proxy用于生成代理类实例，代理类继承Proxy，同时实现接口，InvocationHandler通过invoke方法反射调用被代理类的方法。  
...
## 面向对象的三个特征，五个基本原则
**参考文章：[article](https://www.cnblogs.com/fzz9/p/8973315.html)**  
封装-继承-多态  
...
## 重载和重写的原理
**参考文章：[article](https://blog.csdn.net/fan2012huan/article/details/50999777)**  
**重载：**  
...
## int和Integer
**参考文章：[article](https://www.cnblogs.com/guodongdidi/p/6953217.html)**  
**区别：**  
...
## 消息队列
**参考文章：[article](https://www.jianshu.com/p/36a7775b04ec)**  
消息队列是一个存储消息的容器
#### 消息队列的优缺点
**优点：**  
...
#### 消息队列中问题的解决方案
**参考文章：[article](https://www.cnblogs.com/jack1995/p/10908797.html)**  
...
#### Java序列化
**参考文章：[article](https://www.cnblogs.com/9dragon/p/10901448.html#h)**  
...
#### 序列化底层原理
**参考文章：[article](https://www.imooc.com/article/257722)**    
...
#### 幂等接口的实现
**参考文章：[article1](https://nicky-chen.github.io/2018/03/26/interface-idempotency/)，[article2](https://segmentfault.com/a/1190000014093467)**  
...
#### Java IO流
**参考文章：[article](https://www.jianshu.com/p/e591ca6642e9)**  
根据数据流向分有输入流和输出流  
...
#### Java lambda表达式原理
**参考文章：[article](https://blog.csdn.net/jiankunking/article/details/79825928)**  
...
#### POJO与JavaBean
**参考文章：[article1](https://www.jianshu.com/p/224489dfdec8), [article2](https://www.jianshu.com/p/6f3e2bd50cb1)**  
